...
// My Code
var perScrolled = document.getElementById('scrolled');
...
window.addEventListener('scroll', function(){
	...
	if(bodyHeight - contentScrolled <= windowHeight){
		perScrolled.innerHTML = 100;	
	}
	else{
		var totalHeight = bodyHeight - windowHeight;
		var result = parseInt((contentScrolled / totalHeight) * 100);
		perScrolled.innerHTML = result;
	}
});
